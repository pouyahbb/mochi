...
export const worldToScreen = (world : Point , translate : Point , scale : number) => ({
    x : world.x * scale + translate.x,
    y : world.y * scale + translate.y
})

export const zoomAroundScreenPoint = (originScreen  : Point , newScale : number , currentTranslate  : Point , currentScale : number) => {
...
const viewportSlice = createSlice({
    ...
    reducers : {
        ...
        zoomToFit(state , action:PayloadAction<{bounds:Rect , viewportPx:{width : number , height : number} , padding?:number}> ) {
