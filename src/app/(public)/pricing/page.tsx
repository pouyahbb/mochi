import SubscripionButton from '@/components/buttons/checkout'
...
const Page = () => {
    return (
        <div className='min-h-screen bg-background flex items-center justify-center gap-4 py-24 px-6'>
                ...
                <Card className='backdrop-blur-xl bg-white/8 border border-white/12 shadow-xl saturate-150'>
                    ...
                    <CardContent className="space-y-4 px-6">
                        <div className="text-center">
                            <p className="text-muted-foreground text-sm leading-relaxed mt-2"> Perfect for freelancers and creators who want reliable access to code generation, exports, and other premium features without over-commiting. </p>
                        ...
                        <div className="space-y-3">
                            <h3 className="text-base font-semibold text-foreground text-center mb-3"> what&apos;s Included </h3>
                            <div className="grid gap-2">
                                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/8">
                                    ...
                                    <div >
                                        <p className="text-foreground font-medium text-sm">AI-Powered Design Generation</p>
                                        <p className="text-muted-foreground text-xs"> Transform sketches into production-ready code </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/8">
                                    ...
                                    <div >
                                        <p className="text-foreground font-medium text-sm">Premium Assets Export</p>
                                        <p className="text-muted-foreground text-xs"> High-quality exports in multiple formats </p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/8">
                                    <div className="w-6 h-6 bg-primary/20 rounded-md flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div >
                                        <p className="text-foreground font-medium text-sm">Advance Processing</p>
                                        <p className="text-muted-foreground text-xs"> Run complex design operations and transformations </p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/8">
                                    <div className="w-6 h-6 bg-primary/20 rounded-md flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div >
                                        ...
                                        <p className="text-muted-foreground text-xs"> Flexible usage for your design needs </p>
                                    </div>
                                </div>
