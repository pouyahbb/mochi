    ...
    return (
        <div className="col-span-1 flex justify-end items-center">
            <div className="flex items-center gap-1 backdrop-blur-xl bg-white/8 border border-white/12 rounded-full p-3 saturate-150">
                <Button variant="ghost" size="lg" onClick={handleZoomOut} className="w-9 h-9 p-8 rounded-full cursor-pointer hover:bg-white/12 border border-transparent hover:border-white/16 transition-all" title="Zoom Out">
