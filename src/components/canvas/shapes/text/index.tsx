...
export const Text = ({shape} : {shape : TextShape}) => {
    ...
    return (
        <div 
            ...
            className="absolute pointer-event-none cursor-text select-none rounded px-2 py-1"
            onDoubleClick={handleDoubleClick}
            title="Double-click to edit"    
        >
            <span className="pointer-events-auto" style={{display:"block" , minWidth:"20px" , minHeight : "1em"}}>
                {shape.text}
            </span>
        </div>
    )
