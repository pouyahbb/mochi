...
const ChatWindow = ({generatedUIId , isOpen ,onClose} : Props) => {
  ...
  return (
    <div className={cn("fixed right-5 top-1/2 transform-y-1/2 w-96 h-[600px] backdrop-blur-xl bg-white/8 border-white/12 border rounded-lg z-50 transition-all duration-300 flex flex-col",
